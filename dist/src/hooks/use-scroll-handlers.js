...
export function resolveScrollRef(ref) {
    ...
    // SectionList
    if ((_g = ref.current) === null || _g === void 0 ? void 0 : _g._wrapperListRef) {
        return (_k = (_j = (_h = ref.current) === null || _h === void 0 ? void 0 : _h._wrapperListRef) === null || _j === void 0 ? void 0 : _j._listRef) === null || _k === void 0 ? void 0 : _k._scrollRef;
    }
    // ScrollView
    return ref.current;
}
